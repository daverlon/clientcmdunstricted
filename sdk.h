...
public:
	...
	virtual void		ComputeDynamicLighting(const void* pt, const void* pNormal, void* color) = 0;

	// Returns the color of the ambient light
	virtual void		GetAmbientLightColor(void* color) = 0;
	...
	virtual bool		DoesBoxTouchAreaFrustum(const void* mins, const void* maxs, int iArea) = 0;
	...
	virtual void		ComputeLighting(const void* pt, const void* pNormal, bool bClamp, void* color, void* pBoxColors = 0) = 0;

	// Activates/deactivates an occluder...
	virtual void		ActivateOccluder(int nOccluderIndex, bool bActive) = 0;
	virtual bool		IsOccluded(const void* vecAbsMins, const void* vecAbsMaxs) = 0;
	...
	virtual void* IsSkyboxVisibleFromPoint(const void* vecPoint) = 0;
	...
	virtual void*			GetLightForPointFast(const void* pos, bool bClamp) = 0;
